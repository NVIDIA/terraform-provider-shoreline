...
func (t *ResourceTranslator) ToAPIModel(ctx *common.RequestContext, data *coretranslator.TranslationData, tfModel *resourcetf.ResourceTFModel) (*statement.InputAPIModel, error) {
