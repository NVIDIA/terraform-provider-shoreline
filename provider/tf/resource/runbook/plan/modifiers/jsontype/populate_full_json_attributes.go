...
var (
	JSON_ATTRIBUTES_TO_POPULATE = map[string]JsonAttributeConfig{
		...
		"params": {
			...
			GetReplacementAttr: func(m *model.RunbookTFModel) attr.Value { return m.ParamsList },
		},
		"external_params": {
			...
			GetReplacementAttr: func(m *model.RunbookTFModel) attr.Value { return m.ExternalParamsList },
		},
	}
)
