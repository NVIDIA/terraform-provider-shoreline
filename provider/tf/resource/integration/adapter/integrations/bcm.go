...
type BcmDataAdapter struct{}

// Ensure the adapter implements the IntegrationDataAdapter interface
var _ adapterinterface.IntegrationDataAdapter = &BcmDataAdapter{}

func bcmTfModelFieldNames() []string {
	return []string{"idp_name", "cache_ttl_ms", "api_rate_limit"}
}
func (a *BcmDataAdapter) DataFieldNames() []string {
	return bcmTfModelFieldNames()
}

func (a *BcmDataAdapter) TFModelFieldNames() []string {
	return bcmTfModelFieldNames()
}

func (a *BcmDataAdapter) MapToTFModel(requestContext *common.RequestContext, options *adapterinterface.IntegrationDataAdapterOptions, integrationData map[string]interface{}, tfModel *model.IntegrationTFModel) {
...
func (a *BcmDataAdapter) TFModelToMap(requestContext *common.RequestContext, options *adapterinterface.IntegrationDataAdapterOptions, tfModel *model.IntegrationTFModel) map[string]interface{} {
